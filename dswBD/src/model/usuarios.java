...
public @Data class usuarios {
	...
	public usuarios(int id, String nome, String telefone, String cpf, String senha, String foto, boolean administrator,
	...
	public String toString() {
		return "usuarios [id=" + id + ", nome=" + nome + ", telefone=" + telefone + ", cpf=" + cpf + ", senha=" + senha
